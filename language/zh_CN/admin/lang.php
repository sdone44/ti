...
return [
    ...
    'text_use_default' => '使用默认值',
    'text_updated' => '已更新',
    'text_added' => '已添加',
    'text_deleted' => '已删除',
    'text_default' => '默认 ',
    'text_select_all' => '全选',
    'text_select_none' => '全不选',
    'text_select' => '选择',
    'text_all_locations' => '所有地点',
    'text_selected' => '已选择',
    'text_now' => '现在',
    'text_never' => '从不',
    'text_remove' => '删除',
    ...
    'text_loading' => '加载中...',
    'text_deleting' => '正在删除...',
    'text_about_tastyigniter' => '关于 TastyIgniter',
    'text_documentation' => '说明文档',
    'text_community_support' => '社区支持',
    'text_empty' => '空白',
    'text_help' => '点击获取帮助',
    'text_no_title' => '无标题',
    'text_allow' => '同意',
    ...
    'column_id' => 'ID',
    'column_location' => '地点',
    'column_date_added' => '已添加日期',
    'column_date_updated' => '已升级日期',

    'text_filter_location' => '查看所有地点',
    'text_filter_status' => '查看所有状态',
    'text_filter_date' => '查看所有日期',
    'text_back_link' => '返回上一页',
    'text_admin_link' => '返回管理界面',

    'button_new' => '<i class="fa fa-plus"></i>&nbsp;&nbsp;新建',
    'button_delete' => '<i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除',
    'button_add' => '添加',
    'button_edit' => '编辑',
    'button_continue' => '继续',
    'button_filter' => '过滤',
    'button_save' => '<i class="fa fa-save"></i>&nbsp;&nbsp;保存',
    'button_save_close' => '<i class="fa fa-save"></i>&nbsp;&nbsp;保存并关闭',
