...
return [
    ...
    'help_payment_fee' => '將付款費用應用到購物車',
    'help_tip_condition' => 'Applies tips to cart.',

    'checkout' => [
        'text_heading' => 'Checkout',
        'text_checkout' => '即將完成，請確認您的詳細資料並付款。',
        'text_payments' => '選擇付款方式',
        ...
        'error_invalid_payment' => '選擇的付款方式無效，請盡速聯絡我們。',
